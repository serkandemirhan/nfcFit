    ...
    const TaskCard: FC<{ task: Task }> = ({ task }) => {
        ...
        return (
            <div
                ...
                className={`bg-gray-800 p-3 rounded-lg shadow-md mb-3 cursor-pointer active:cursor-grabbing ${isOverdue ? 'border-l-4 border-red-500' : ''} ${draggedTaskId === task.id ? 'opacity-50' : ''}`}
            >
                        ...
                        {allTasksSorted.map(task => {
                            ...
                            return (
                                <tr
                                    key={task.id}
                                    onClick={() => onEditTask(task)}
                                    className="border-b border-gray-800 hover:bg-gray-800/50 cursor-pointer transition-colors h-8"
                                >
